                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nuevo_nombre_persona" name="nombre_persona"
                                    ...
                                    title="Solo letras y espacios, máximo 3 letras iguales seguidas y mínimo nombre y apellido"
                                    oninput="limpiarNombre(this)">
                                <div class="invalid-feedback">
                                    Por favor ingrese un nombre válido: mínimo nombre y apellido, sin más de 3 letras
                                    repetidas.
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nuevo_dni" name="dni" required
                                    pattern="^0\d{3}-\d{4}-\d{5}$"
                                    title="Debe iniciar con 0 y tener el formato 0000-0000-00000" maxlength="15"
                                    placeholder="0801-3456-78901" oninput="formatearDNI(this)">
                                <div class="invalid-feedback">
                                    El DNI debe iniciar con 0 y tener el formato 0000-0000-00000.
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="tel" class="form-control" id="nuevo_telefono" name="telefono" required
                                    maxlength="8" pattern="^[983](?!.*(\d)\1{3})\d{7}$"
                                    title="Debe tener 8 dígitos, iniciar con 9, 8 o 3 y no repetir un número más de 3 veces seguidas"
                                    oninput="limpiarTelefono(this)">
                                <div class="invalid-feedback">
                                    Ingrese un número válido (8 dígitos, inicia con 9, 8 o 3, sin más de 3 dígitos
                                    iguales seguidos).
                                </div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="nuevo_cargo" name="cargo" required
                                    ...
                                    title="Solo letras y espacios" oninput="limpiarCargo(this)">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="12539.68" max="9999999.99" class="form-control"
                                    id="nuevo_salario" name="salario" required oninput="validarLimiteSalario(this)"
                                    title="Ingrese un salario mayor o igual a L. 12,539.68">
                                <div class="invalid-feedback">Ingrese un salario válido (mínimo L. 12,539.68).</div>
                            </div>
                    ...
                    <div class="modal-body p-4">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <div class="invalid-feedback">Ingrese un nombre válido (solo letras, máximo 50
                                    caracteres).</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="edit_dni" name="dni" required maxlength="13"
                                    pattern="\d{13}" title="Debe contener exactamente 13 dígitos" inputmode="numeric"
                                    oninput="this.value = this.value.replace(/[^0-9]/g, '').slice(0,13)">
                                <div class="invalid-feedback">Ingrese un DNI válido (exactamente 13 dígitos).</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="invalid-feedback">Ingrese un correo electrónico válido (máximo 100
                                    caracteres).</div>
                            </div>
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="invalid-feedback">Ingrese la dirección (máximo 150 caracteres).</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control" id="edit_cargo" name="cargo" required
                                    ...
                                    title="Solo letras y espacios (máximo 50 caracteres)"
                                    oninput="this.value = this.value.replace(/[^A-Za-zÁÉÍÓÚáéíóúÑñ\s]/g, '').slice(0,50)">
                                <div class="invalid-feedback">Ingrese un cargo válido (solo letras y máximo 50
                                    caracteres).</div>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" step="0.01" min="1" max="9999999.99" class="form-control"
                                    id="edit_salario" name="salario" required
                                    oninput="if(this.value < 1 || this.value > 9999999.99) this.value = ''">
                                <div class="invalid-feedback">
                                    Ingrese un salario válido (entre L. 1.00 y L. 9,999,999.99).
                                </div>
                            </div>
