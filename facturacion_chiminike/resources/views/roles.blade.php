...
<body>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            inputNombreRol.addEventListener('input', function () {
                const soloPermitido = /[^A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ]/g;
                this.value = this.value.replace(soloPermitido, '');
            });
        });
    </script>
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            descripcionInput.addEventListener('input', function () {
                const permitido = /[^A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ,.]/g;
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            const editarNombreRol = document.getElementById('editar_nombre_rol');

            editarNombreRol.addEventListener('input', function () {
                const permitido = /[^A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ]/g;
                this.value = this.value.replace(permitido, '');
            });
        });
    ...
    <script>
        document.addEventListener('DOMContentLoaded', () => {
            const el = document.getElementById('editar_descripcion_rol');
            if (!el) return;
            el.addEventListener('input', function () {
                const max = +this.maxLength || 100;
                this.value = this.value.replace(/\r?\n/g, ' ').replace(/[^A-Za-zÁÉÍÓÚáéíóúÑñ0-9 ,.]/g, '').slice(0, max);
            });
        });
    </script>
