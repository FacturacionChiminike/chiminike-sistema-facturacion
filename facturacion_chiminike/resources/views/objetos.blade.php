...
<body>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const tipoObjetoInput = document.getElementById("nuevo_tipo_objeto");

            tipoObjetoInput.addEventListener("keypress", function (e) {
                if (e.key === "@") {
                    e.preventDefault();
                }
            });
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function () {
            const editarTipoObjeto = document.getElementById("editar_tipo_objeto");

            editarTipoObjeto.addEventListener("keypress", function (e) {
                if (e.key === "@") {
                    e.preventDefault();
                }
            });
