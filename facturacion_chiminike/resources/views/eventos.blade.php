...
<head>
    ...
    <title>Eventos Completados - Sistema de Gestión</title>
    ...
    <div class="main-content">
        <div class="container-fluid py-4">
            ...
            <div class="d-flex justify-content-between align-items-center mb-4">
                <h2 class="mb-0"><i class="bi bi-check-circle me-2"></i> Eventos Completados</h2>
            ...
            <div class="card shadow border-0">
                <div class="card-header bg-primary text-white">
                    <h4 class="mb-0"><i class="bi bi-list-check me-2"></i> Listado de Eventos</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-hover align-middle text-center">
                            ...
                            <tbody>
                                @if(isset($cotizaciones) && count($cotizaciones) > 0)
                                    @foreach($cotizaciones as $index => $c)
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-success text-uppercase">{{ $c['estado'] }}</span>
                                            </td>
                                ...
                                @else
                                    <tr>
                                        <td colspan="8" class="text-center py-4">No hay eventos completados</td>
                                    </tr>
                                @endif
                            </tbody>
                        </table>
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered">
            <div class="modal-content border-0 shadow-lg">
                <div class="modal-header bg-success text-white">
                    <h5 class="modal-title"><i class="bi bi-file-earmark-text me-2"></i> Detalle del Evento</h5>
                        ...
                        <div class="contenedor-modal">
                            ...
                            <div class="d-flex justify-content-between align-items-center mb-3">
                                ...
                                <div class="text-center">
                                    ...
                                    <p class="mb-0 fw-semibold">Evento Completado</p>
                                </div>
                                <img src="{{ asset('img/manologochiminike.jpeg') }}" alt="Logo Chiminike" style="width: 80px;">
                            </div>
    ...
    <script>
        document.querySelectorAll('.btn-detalle').forEach(btn => {
            btn.addEventListener('click', function() {
                ...
                fetch(`http://68.168.222.45:3000/cotizaciones/completadas/${id}`)
                    ...
                    .then(data => {
                        if (data && data.length > 0) {
                            ...
                            document.getElementById('btn-enviar-correo').onclick = () => {
                                alert('Enviar por correo en construcción...');
                            };

                            const modal = new bootstrap.Modal(document.getElementById('detalleModal'));
                            modal.show();
                        } else {
                            Swal.fire('Error', 'No se encontraron detalles para este evento', 'error');
                        }
                    })
                    .catch(error => {
                        console.error(error);
                        Swal.fire('Error', 'Error al obtener los detalles del evento', 'error');
                    });
            });
        });
    </script>
